...
root = tk.Tk()
root.title("BRAIN TUMOUR DETECTION SYSTEM")
...
def edges():
    ...
    img3.image = imgtk
    img3.place(x=900, y=60)

    eg = edges

heading = tk.Label(root,width=75,text='---BRAIN TUMOUR DETECTION SYSTEM---',background='yellow',foreground='black',font=("Tempus Sans ITC",25,"bold"))
heading.place(x=5,y=5)



button_p1 = tk.Button(tab1,text="Browse Photo", command=bphoto,width=15,height=2,background="green",foreground="snow",font=("Tempus Sans ITC",14,"bold"))
button_p1.grid(column=0, row=1, sticky=tk.W, padx=10, pady=10)
button_p1.place(x=50, y=520)

button_p2 = tk.Button(tab1,text="Gray Scale", command=Gray_Scale, width=15,height=2,background="green",foreground="snow",font=("Tempus Sans ITC",14,"bold"))
button_p2.grid(column=1, row=1, sticky=tk.W, padx=10, pady=10)
button_p2.place(x=250, y=520)

button_p3 = tk.Button(tab1, text="Threshold", command=analysis,width=15,height=2,background="green",foreground="snow",font=("Tempus Sans ITC",14,"bold"))
button_p3.grid(column=2, row=1, sticky=tk.W, padx=10, pady=10)
button_p3.place(x=450, y=520)

button_p4 = tk.Button(tab1, text="Edges", command=edges,width=15,height=2,background="green",foreground="snow",font=("Tempus Sans ITC",14,"bold"))
button_p4.grid(column=2, row=1, sticky=tk.W, padx=10, pady=10)
button_p4.place(x=650, y=520)

quitWindow = tk.Button(tab1, text="Quit", command=root.destroy,width=15,height=2,background="blue",foreground="white",font=("Tempus Sans ITC",14,"bold"))
