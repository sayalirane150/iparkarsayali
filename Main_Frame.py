...
tabControl.configure(bg=yellow)
...
frame3 = tk.LabelFrame(tab3, text="Detection", width=1000, height=600, bd=2)
#frame2 = tk.LabelFrame(tab2, text="Alexnet", width=980, height=500, bd=5)
frame1 = tk.LabelFrame(tab1, text="Lung Cancer  Breath mothion Detection python", width=1000, height=600, bd=2, )
